...
import com.diagorn.sqltrainer.utils.validInsert
...
/**
 * Сервис проверки запросов на добавление данных
 *
 * @author Diagorn
 */
@Service
class InsertCheckService(
    ...
    override fun getDmlCommand(): DmlCommandsEnum = DmlCommandsEnum.INSERT
}